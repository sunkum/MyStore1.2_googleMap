...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
 ...
 /*   NSManagedObject *newDevice = [NSEntityDescription insertNewObjectForEntityForName:@"Device" inManagedObjectContext:managedObjectContext];
    ...
    [NSURLConnection sendAsynchronousRequest:request queue:[NSOperationQueue currentQueue] completionHandler:^(NSURLResponse *response, NSData *data, NSError *connectionError) {
        ...
        NSString *personName = json[@"responsData"][@"results"][0][@"contentNoFormatting"];
        NSString *personImageURL = json[@"responseData"][@"results"][0][@"tbUrl"];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "BSB.MyStore" in the application's documents directory.
